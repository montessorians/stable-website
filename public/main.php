...
if(empty($_SESSION['account_type'])){
		...
		switch($account_type){
			case("student"):
				...
				include("_interface/student/common.php");
				break;
			case("admin"):
				include("_interface/admin/common.php");
				$admin_id = $db_account->get("admin_id", "user_id", "$user_id");
				break;
			case("teacher"):
				include("_interface/teacher/common.php");
				$teacher_id = $db_account->get("teacher_id", "user_id", "$user_id");
				break;
			case("parent"):
				include("_interface/parent/common.php");
				$parent_id = $db_account->get("parent_id", "user_id", "$user_id");
				break;
			case("staff"):
				include("_interface/staff/common.php");
				$staff_id = $db_account->get("staff_id", "user_id", "$user_id");
				break;
			case("developer"):
				include("_interface/developer/common.php");
