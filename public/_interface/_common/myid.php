  		...
  		<div class="modal-content">
  			<center>
  				<a href="https://chart.googleapis.com/chart?cht=qr&chs=300x300&chl=<?=$student_id?>" target="_blank" rel="noopener">
  					<img src="https://chart.googleapis.com/chart?cht=qr&chs=300x300&chl=https://hcmontessori.000webhostapp.com/forms/ecash/transact.php?student_id=<?=$student_id?>" class='responsive-img round'>
  				</a>
  				<p class="white-text">
