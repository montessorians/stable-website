...
<nav class="nav-extended <?=$primary_color?>">
    <div class="nav-wrapper">
      ...
      <a href="#myid" class="button-collapse hide-on-med-and-up right modal-trigger" id="notif-trigger"><i class="material-icons">fingerprint</i></a>
    </div>
    <div class="nav-content">
					<ul class="tabs tabs-transparent">
						...
						<li class="tab"><a href="#ecash"><i class="material-icons">account_balance_wallet</i></a></li>
